...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("C:\Users\mayaw\Documents\Python-Playlist-Player\songs","")
...
def Play():
    ...
    song=f'C:\Users\mayaw\Documents\Python-Playlist-Player\songs{song}'
...
def Previous():
    ...
    temp2=f'C:\Users\mayaw\Documents\Python-Playlist-Player\songs{temp2}'
